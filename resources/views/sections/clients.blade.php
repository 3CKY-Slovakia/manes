            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="Title-area">
                        <h3>Veria nám</h3>
                        <h2>Referencie</h2>
                        <p>Výsledky odporúčajú MANES, a.s. ako spoľahlivú inkasnú spoločnosť, dôveryhodného partnera pre biznis, a úprimného poradcu a konzultanta pre inkasné situácie.</p>
                    </div>
                </div>
            </div>
        </div>
